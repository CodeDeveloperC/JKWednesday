            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    <tr>
                        ...
                        <td class="tableContent"><input type="text" name="customerName"/></td>
                        <td class="columnTitle_mustbe">收购方：</td>
                        <td class="tableContent"><input type="text" name="offeror" value="杰鑫商贸有限公司"/></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tableContent">
                            <input type="text" style="width: 90px;" name="deliverPeriod"
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><textarea style="height: 120px;" name="crequest"></textarea></td>
                        <td class="columnTitle_mustbe">说明：</td>
                        <td class="tableContent"><textarea style="height: 120px;" name="remark"></textarea></td>
                    </tr>
                </table>
            </div>
        </div>

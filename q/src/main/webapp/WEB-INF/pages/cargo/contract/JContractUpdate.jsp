            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    <tr>
                        ...
                        <td class="tableContent"><input type="text" name="customerName" value="${obj.customerName}"/></td>
                    ...
                    <tr>
                        ...
                        <td class="tableContent">
                            <input type="text" style="width: 90px;" name="deliverPeriod" value="<fmt:formatDate value="${obj.deliverPeriod}" pattern="yyyy-MM-dd"/> "
                                   onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyy-MM-dd'});"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><textarea style="height: 120px;" name="crequest">${obj.crequest}</textarea></td>
                        <td class="columnTitle_mustbe">说明：</td>
                        <td class="tableContent"><textarea style="height: 120px;" name="remark">${obj.remark}</textarea></td>
                    </tr>
                </table>
            </div>
        </div>

            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    <tr>
                        ...
                        <td class="tableContent">${obj.customerName}</td>
                    ...
                    <tr>
                        ...
                        <td class="tableContent">
                            <fmt:formatDate value="${obj.deliverPeriod}" pattern="yyyy-MM-dd"/>
                        </td>
                ...
                <table id="ec_table" class="tableRegion" width="98%">
                    ...
                    <c:forEach items="${obj.contractProducts}" var="cp" varStatus="status">
                        ...
                        <c:forEach items="${cp.extCproducts}" var="ext" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                                <td><font color="green">附件：</font>${status.index+1} </td>

            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><textarea style="height: 120px;" name="seller"></textarea></td>
                        <td class="columnTitle_mustbe">买方：</td>
                        <td class="tableContent"><textarea style="height: 120px;" name="buyer"></textarea></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="tableContent"><textarea style="height: 120px;" name="marks"></textarea></td>
                        <td class="columnTitle_mustbe">描述：</td>
                        <td class="tableContent"><textarea style="height: 120px;" name="descriptions"></textarea></td>
                    </tr>
                </table>
            </div>
        </div>

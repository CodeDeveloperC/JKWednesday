...
<head>
    ...
    <script type="text/javascript">
        $().ready(function () {
            ${mRecordData}
//            addTRRecord("11p", "id", "productNo", "cnumber", "grossWeight", "netWeight", "sizeLength", " sizeWidth", " sizeHeight", " exPrice", " tax");
        });
            ...
            <div>
                <table class="commonTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="tableContent">${obj.customerContract}
                        ...
                        <td class="tableContent">
                            <input type="text" style="width: 90px;" name="inputDate"
                                   ...
                                   onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyy-MM-dd'});"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <input type="radio" name="transportMode" value="AIR" class="input"
                               <c:if test="${obj.transportMode=='AIR'}">checked</c:if>/>AIR</td>
                        ...
                        <input type="radio" name="priceCondition" value="CIF" class="input"
                               <c:if test="${obj.priceCondition=='CIF'}">checked</c:if>/>CIF</td>
                    </tr>

                    <tr>
                        <td class="columnTitle_mustbe">唛头：</td>
                        <td class="tableContent"><textarea style="height: 120px;" name="marks">${obj.marks}</textarea>
                        </td>
                        <td class="columnTitle_mustbe">备注：</td>
                        <td class="tableContent"><textarea style="height: 120px;" name="remark">${obj.remark}</textarea>
                        </td>
                    </tr>
                </table>
            </div>
